    ...
    protected function _getWishlist($wishlistId = null)
    {
        ...
        try {
			...
			if(!$is_approver)
			{
				...
				$approver_id = $customerData['approver'];
				$wishlist_id = $wishlist->getCustomerId();
           
				//echo "kkk " . $approver_id . " KKK " . $customerId . " KKK " . $wishlist_id;
				$tpnCustomerId = $approver_id;
			}
			else
				$tpnCustomerId = $customerId;
			...
			//echo $approver_id . " ". $customerId . " ". $wishlist_id;           
			if ($wishlist->getId() && ($wishlist->getCustomerId() == $customerId || $wishlist->getCustomerId() == $tpnCustomerId)) {
				$a = 0;
			}	
            else{
				$approver_id = $customerData['approver'];
				...
				$wishlist = null;
                Mage::throwException(
                    Mage::helper('wishlist')->__("Requested wishlist doesn't exist ". $approver_id . " ". $customerId . " ". $wishlist_id)
                );
            }
