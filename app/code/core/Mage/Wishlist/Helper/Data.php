...
class Mage_Wishlist_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getWishlist()
    {
      ...
      // check if customer is approver
       ...
       if(1== $this->getCustomer()->getIsApprover()){
        ...
        if (is_null($this->_wishlist)) {
           ...
           // not approver, show approver's catalog

        else{

          $approver = Mage::helper('orderapproval')->getApproverForCustomer($this->getCustomer());
          $this->_wishlist = Mage::getModel('wishlist/wishlist');
          $this->_wishlist->loadByCustomer($approver);    
