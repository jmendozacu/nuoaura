...
class Mage_Adminhtml_Block_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
		...
		//->joinAttribute('company', 'sales_flat_order_address/company', 'entity_id', null, 'left');
		...
		$collection = Mage::getResourceModel($this->_getCollectionClass())
                ->join(
                    array('soa' => 'sales/order_address'),
                   	'soa.parent_id=main_table.entity_id and soa.address_type = "billing"', 
                    array('soa.company','soa.lastname', 'soa.street'),
					NULL,'left');
		...
		//print_r(parent::_prepareCollection());
